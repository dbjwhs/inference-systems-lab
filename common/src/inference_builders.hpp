...
public:
     ...
     */
    RuleBuilder& whenCondition(const std::string& predicate, const std::vector<Value>& args, bool negated = false);
     ...
     */
    RuleBuilder& thenConclusion(const std::string& predicate, const std::vector<Value>& args, double confidence = 1.0);
...
public:
     ...
     */
    QueryBuilder& goal(const std::string& predicate, const std::vector<Value>& args, bool negated = false);
